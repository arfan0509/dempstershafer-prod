...
const RiwayatDiagnosisAdmin = () => {
    ...
    return (_jsxs("div", { className: "flex-1 p-2 min-h-screen", children: [_jsx("h1", { className: "text-3xl font-bold text-[#4F81C7] mb-6", children: "Riwayat Diagnosis" }), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6", children: [_jsxs("div", { className: "flex gap-2", children: [_jsx("input", { type: "text", placeholder: "Cari nama pasien/kucing/penyakit...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "p-2 border rounded-lg w-full focus:ring-[#4F81C7]" }), _jsx("button", { onClick: handleSearch, className: "bg-[#4F81C7] text-white px-4 py-2 rounded-lg hover:bg-[#3e6b99]", children: _jsx(FiSearch, { size: 18 }) })] }), _jsxs("select", { value: selectedPatient, onChange: (e) => setSelectedPatient(e.target.value), className: "p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4F81C7]", children: [_jsx("option", { value: "", children: "Semua Pasien" }), patients.map((name) => (_jsx("option", { value: name, children: name }, name)))] }), _jsxs("select", { value: sortOrder, onChange: (e) => setSortOrder(e.target.value), className: "p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4F81C7]", children: [_jsx("option", { value: "baru", children: "Urutkan: Terbaru" }), _jsx("option", { value: "lama", children: "Urutkan: Terlama" })] })] }), loading ? (_jsx("div", { className: "flex justify-center items-center py-20", children: _jsx("div", { className: "animate-spin border-4 border-[#4F81C7] border-t-transparent rounded-full w-16 h-16" }) })) : (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6", children: currentData.map((diagnosis, index) => (_jsxs("div", { className: "bg-[#F8FAFC] p-6 rounded-lg shadow-md hover:shadow-xl border-l-4 border-[#4F81C7] transition duration-300", children: [_jsxs("div", { className: "space-y-3", children: [_jsxs("p", { className: "flex items-center gap-2", children: [_jsx(FiUser, { className: "text-[#4F81C7]" }), _jsx("strong", { children: "Nama Pasien:" }), " ", diagnosis.pasien.nama] }), _jsxs("p", { className: "flex items-center gap-2", children: [_jsx(FiMapPin, { className: "text-[#4F81C7]" }), _jsx("strong", { children: "Alamat:" }), " ", diagnosis.pasien.alamat] }), _jsxs("p", { className: "flex items-center gap-2", children: [_jsx(FiPhone, { className: "text-[#4F81C7]" }), _jsx("strong", { children: "No. Telepon:" }), " ", diagnosis.pasien.no_telp] }), _jsxs("p", { className: "flex items-center gap-2", children: [_jsx(FiHeart, { className: "text-[#4F81C7]" }), _jsx("strong", { children: "Nama Kucing:" }), " ", diagnosis.nama_kucing] }), _jsx("div", { className: "border-t border-gray-300 my-2" }), _jsxs("p", { className: "flex items-center gap-2", children: [_jsx(FiCalendar, { className: "text-[#4F81C7]" }), _jsx("strong", { children: "Usia:" }), " ", diagnosis.usia] }), _jsxs("p", { className: "flex items-center gap-2", children: [_jsx(FiTag, { className: "text-[#4F81C7]" }), _jsx("strong", { children: "Jenis Kelamin:" }), " ", diagnosis.jenis_kelamin] }), _jsxs("p", { className: "flex items-center gap-2", children: [_jsx(FiFeather, { className: "text-[#4F81C7]" }), _jsx("strong", { children: "Warna Bulu:" }), " ", diagnosis.warna_bulu] }), _jsx("div", { className: "border-t border-gray-300 my-2" }), _jsxs("p", { className: "flex items-center gap-2", children: [_jsx(FiAlertCircle, { className: "text-[#4F81C7]" }), _jsx("strong", { children: "Penyakit:" }), " ", diagnosis.hasil_diagnosis.penyakit] }), _jsxs("p", { className: "flex items-center gap-2", children: [_jsx(FiThermometer, { className: "text-[#4F81C7]" }), _jsx("strong", { children: "Gejala Terdeteksi:" }), " ", diagnosis.hasil_diagnosis.gejala_terdeteksi.join(", ")] }), diagnosis.hasil_diagnosis.kemungkinan_penyakit_lain &&
